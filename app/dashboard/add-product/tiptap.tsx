...
import { Bold, Code, Italic, List, ListOrdered, Strikethrough, Text, TextSelectionIcon, Underline } from 'lucide-react'
        ...
        <div className="flex flex-col gap-2">
            {editor && (
                <div className="border-input border rounded-md">
                    ...
                    <Toggle pressed={editor.isActive("code")} onPressedChange={() => editor.chain().focus().toggleCode().run()} size={"sm"}>
